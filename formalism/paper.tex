...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% lem:unused %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% last revised and checked: 2013/01/04

\begin{lem}
\label{lem:unused}
Given an arbitrary term $t$ such that 
$\typerule{\Gamma, x : T}{t}{U}{\Gamma', x : V}$ where $x$ is unused in
$t$, $T <: V$.
\end{lem}

\begin{proof}
Straightforward observation from the typing rules.
\end{proof}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% lem:remapcv %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% revised and checked 2013/01/04
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% lem:subst %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% revised and checked: 2013/01/05
...
%! extended proof of construction of principal types when some annotations
%! provided, and some are missing
%
% so that 
% $t$ is typeable by rule \tfunc.
% Let $\Gamma_3 = \overline{x_i : T_i}$.
...
%%% TODO: parts of this solution are existentially quantified, and not shown
%%% to be the smallest / largest types possible to get the principal typing 
%%% result.
...
%%% DODGY need better way to construct type T' type or bound it.
